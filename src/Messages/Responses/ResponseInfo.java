...
public class ResponseInfo
{
    ...
    {{
        ...
        put(101, "Username doesn't exist or password is incorrect");
        put(102, "Username is already logged in");
    ...
    {{
        ...
        put(102, "Username doesn't exist or old password is incorrect");
        put(103, "New password matches the old password");
        put(104, "Username is currently logged in");
